...
public enum ConsoleTheme implements StringRepresentable {
    ...
    FACTORY("factory", new ControlSpecification[] {
            ...
            new ControlSpecification(ConsoleControl.DIMENSION, new Vector3f(0f, 0.7f, 0.6f), new BlockPos(0.1f, 0.1f, 0.1f))
    }),
    ...
    CRYSTAL("crystal", new ControlSpecification[] {
            ...
            new ControlSpecification(ConsoleControl.DIMENSION, new Vector3f(-0.3F - 0.09F, 0.55F, -0.7F - 0.02F), BlockPos.ZERO)
    }),
    ...
    COPPER("copper", new ControlSpecification[] {
            ...
            new ControlSpecification(ConsoleControl.DIMENSION, new Vector3f(1.076f, 0.6f, -0.271f), new BlockPos(0.1f, 0.1f, 0.1f))
    }),
    ...
    CORAL("coral", new ControlSpecification[] {
            ...
            new ControlSpecification(ConsoleControl.DIMENSION, new Vector3f(-1.1f, 0.40625f, -0.449f), new BlockPos(0.1f, 0.1f, 0.1f))
    }),
    ...
    TOYOTA("toyota", new ControlSpecification[] {
            ...
            new ControlSpecification(ConsoleControl.DIMENSION, new Vector3f(-0.31f, 0.525f, 1f), new BlockPos(0.1f, 0.1f, 0.1f))
    }),
    ...
    NUKA("nuka", new ControlSpecification[] {
            ...
            new ControlSpecification(ConsoleControl.DIMENSION, new Vector3f(0.225f,0.6f,1), new BlockPos(0.125f, 0.1875f, 0.1875f))
    });
